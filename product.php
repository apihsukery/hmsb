...
<div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="left-side sidebar-offcanvas">
                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li>
                            <a href="user.php?name=<?php echo $rec['name'] ?>">
            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Product Registrations</li>
                    </ol>
                </section>
                ...
                <section class="content">
                            ...
                            <div class="small-box bg-aqua">
                                <div class="inner">
                                    ...
                                    <h3>
                                        <?php 
                                          $bil=0;
                                          while ($rec1 = mysql_fetch_array($product)) { $bil++; } echo $bil;?>
                                    </h3>
                                    <p>
                                        Total Product<br>Registrations
                                    </p>
                                </div>
                                <br>
                                <div class="icon">
                    ...
                    <div class="col-md-6 col-md-offset-3" >
                        <button type="button" class="btn btn-info btn-block" style=" height: 50px; " id="myBtn1"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span> Register New Product</button>
                    </div><br>
                                        ...
                                        <?php 
                                          ...
                                          while($rec2 = mysql_fetch_array($product1)) { 
                                            ...
                                            <tbody>
                                                ...
                                                <td width="1">
                                                    <a href="#myModal2" data-toggle="modal" data-id="<?php echo $rec2['id'] ?>" data-name="<?php echo $rec2['name'] ?>" data-price="<?php echo $rec2['price'] ?>" class="btn btn-flat" id="myBtn2" title="Edit"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span></a>
                                                </td>
                                                <td width="1">
                                                    <a href="deleteProduct.php?id=<?php echo $rec2['id']?>" onClick="return confirm('Are you sure to delete this product?');" class="btn btn-flat" title="Delete"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></a>
                                                </td>
                                                </tr>
                                            </tbody>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header modal-header-info" style="padding:35px 50px;">
          ...
          <h4><span class="glyphicon glyphicon-gift" aria-hidden="true"></span> Product Register</h4>
        </div>
        <div class="modal-body" style="padding:40px 50px;">
            <form role="form" name="addPekerja" action="addProductProcess.php" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <div class="icon-addon addon-md">
                    <input type="text" placeholder="Product Name" class="form-control" id="name" name="name" required>
                    <label for="nama" class="glyphicon glyphicon-gift" rel="tooltip" title="nama"></label>
                </div>
            </div>
 ...
 -->              <button type="Submit" class="btn btn-info btn-info1"><span class="glyphicon glyphicon-plus-sign"></span> Add Product</button>
          </form>
        </div>
  ...
  <div class="modal fade" id="myModal2" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header modal-header-info" style="padding:35px 50px;">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
          <h4><span class="glyphicon glyphicon-edit" aria-hidden="true"></span> Edit Product</h4>
        </div>
        <div class="modal-body" style="padding:40px 50px;">
          <form role="form" name="editPekerja" action="editProduct.php" method="post" enctype="multipart/form-data">
...
$('#myModal2').on('show.bs.modal', function(e) {
    ...
    $(e.currentTarget).find('input[id="price"]').val(price);
